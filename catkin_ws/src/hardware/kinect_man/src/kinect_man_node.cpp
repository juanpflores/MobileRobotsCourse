...
int main(int argc, char** argv)
{
    ...
    ros::NodeHandle n;
    ros::Publisher pubKinectFrame =n.advertise<sensor_msgs::PointCloud2>("/hardware/kinect_man/rgbd_wrt_kinect",1);
    ros::Publisher pubRobotFrame  =n.advertise<sensor_msgs::PointCloud2>("/hardware/kinect_man/rgbd_wrt_robot", 1);
    ros::Publisher pubDownsampled =n.advertise<sensor_msgs::PointCloud2>("/hardware/kinect_man/rgbd_wrt_robot_downsampled",1);
    ros::ServiceServer srvRgbdKinect = n.advertiseService("/hardware/kinect_man/get_rgbd_wrt_kinect", kinectRgbd_callback);
    ros::ServiceServer srvRgbdRobot  = n.advertiseService("/hardware/kinect_man/get_rgbd_wrt_robot", robotRgbd_callback);
    ros::ServiceServer srvRgbdKinectDownsampled  = n.advertiseService("/hardware/kinect_man/get_rgbd_wrt_kinect_downsampled", kinectRgbdDownsampled_callback);
    ros::ServiceServer srvRgbdRobotDownsampled  = n.advertiseService("/hardware/kinect_man/get_rgbd_wrt_robot_downsampled", robotRgbdDownsampled_callback);
    sensor_msgs::PointCloud2 msgCloudKinect;
    sensor_msgs::PointCloud2 msgCloudRobot; 
    ...
    else
    {
        ...
        rosbag::View view(bag, rosbag::TopicQuery("/hardware/point_cloud_manager/rgbd_wrt_kinect"));
        while(ros::ok())
        {
