...
int main(int argc, char** argv){
	...
	//Variables para poder realiazr los diferntes giros 
	float alpha = 0.6548;
	float beta  = 0.1;
	float v_max = 0.5;
	float w_max = 0.5;
	float Kpl   = 1.0;
	float Kpa   = 1.0;
	//Variables para poder calcular los errores 
	...
	else if(error_m > 0.1){ //condicion para calcula el posible error que puede llagar 
							//a tener la velocidas
