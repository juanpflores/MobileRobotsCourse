...
int main(int argc, char** argv)
{
    ...
    n.param<float>("/navigation/path_planning/smoothing_alpha",  smoothing_alpha, 0.5);
    ...
    n.param<float>("/navigation/path_planning/nearness_radius",  nearness_radius,   0.5);
