			...
			nav_msgs::OccupancyGrid& map, nav_msgs::Path& result)
{
	...
	for(size_t i=0; i < node_neighbors.size(); i++)
	{
        ...
        // Obtener las coordenadas X y Y del vecino para calcular la distancia MAnhattan
        ...
        // CAlcular la distancia Manhattan entre el vecino y la posiciòn del goal como h
